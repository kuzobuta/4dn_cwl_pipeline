---
  ...
  fdn_meta: 
    ...
    data_types: 
      ...
      - "Capture Hi-C"
      - "ChIA-PET"
    description: "This is a subworkflow of the Hi-C data analysis pipeline. It takes pairs files for all replicates of a sample, merges them and then produces multi-resolution Hi-c matrices for visualization. The pipeline produces 4 output files. 1) Replicated merged pairs file 2) Contact matrices in .hic format 3) Multiresolution mcool file (using cooler v0.9.3) and 4) normalization vector of mcool files for visualization in juicebox."
